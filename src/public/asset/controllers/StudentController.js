app.controller('StudentController', ['$rootScope', '$scope', '$http', '$location', 'AuthenticationService', 'CookieStore', 'locale', '$timeout','$document','StudentServices',
    function ($rootScope, $scope, $http, $location, AuthenticationService, CookieStore, locale, $timeout,$document,StudentServices) {
        var districtOption = {};
        var options = [];
        var school_options = [];
        var schoolOptions = {};
        ...
        var pullXsreStudents = function(studentKeys){
            ...
            angular.forEach($scope.students, function(student){
                ...
                StudentServices.pullxsre(student)
